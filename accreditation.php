...
if(isset($_POST['submit'])){
	$to = "accredidation@adliya-bh.com"; 
	$from = $_POST['email']; 
	$name = $_POST['name'];
	$number = $_POST['number'];
							...
							<div class="mcb-wrap-inner">
								...
								<div class="column mcb-column three-fifth column_column">
									<div class="column_attr clearfix">
										<h4>We offer Accreditation, consultations, studies, feasibility studies, financial reports and management consultations in all fields.</h4>
										<p class="big">
											•	Through our experience in the field of consultations, studies, feasibility studies, financial reports and management consultations in all fields, we would like to inform you,
											owners of small, medium and large enterprises that we are fully prepared to serve you in this field.
										</p>
										<p class="big">
											•	Accreditation is a formal, independent verification that a program or institution meets established quality standards and is competent to carry out specific conformity assessment
											tasks. Conformity assessment tasks may include, but are not limited to, testing, inspection, or certification.
										</p>
										<p class="big">
											•	Typically, governmental regulatory agencies such as National Health Regulatory Authority (NHRA) require accreditation to verify the technical competence of organizations like laboratories,
											inspection bodies, and certification agencies.
										</p>
										<p class="big">
				...
				<div class="mcb-wrap-inner">
					...
					<div class="column mcb-column one-second column_column">
						<div class="column_attr clearfix">
							...
							<h6>Email Address</h6>
							<p>
								<a href="mailto:accredidation@adliya-bh.com" style="text-decoration: none;">accredidation@adliya-bh.com</a>
							</p>
						</div>
					</div>
