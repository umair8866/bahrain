...
<div id="Subheader" style="padding:290px 0 190px">
	<div class="container">
		<div class="column one">
			<h1 class="title">CME Training Registration</h1>
		</div>
	</div>
</div>
</div>
        				...
        				<div class="mcb-wrap-inner">
        					...
        					<div class="column mcb-column three-fifth column_column">
        						<div class="column_attr clearfix">
        							<h4>We provide assistance to Medical Practioners in registration for their CME Training.</h4>
        							<p class="big">
        								CME programs aim to communicate up to date knowledge, health skills and new developments in medicine, and allied health in the Kingdom of Bahrain. We provide assistance to Medical Practitioners in registration for their CME Training.
        							</p>
        						</div>
        					</div>
                            ...
                            <div class="mcb-wrap-inner">
                                ...
                                <div class="column mcb-column one-second column_column">
                                    <div class="column_attr clearfix">
                                        ...
                                        <h6>Email Address</h6>
                                        <p>
                                            <a href="mailto:cme-training@adliya-bh.com" style="text-decoration: none;">cme-training@adliya-bh.com</a>
                                        </p>
                                    </div>
                                </div>
